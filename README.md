...
The saver clones skill data before removing database-only fields, preventing
...
Automated world actions are paced and no longer draw false click crosses at the
...
inventory without banking before the next step begins. The bot panel shows the
active step, progress, and remaining queue. Command queues persist across login. Fatigue
